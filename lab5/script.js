...
const elements = [
    ...
    { id: "e-mail", regex: /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, field: "E-mail" }, // Some random regex from Stack overflow XD. It works btw
    { id: "telegram", regex: /^@[a-zA-Z_0-9]+$/, field: "Telegram" },]
